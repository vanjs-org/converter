...
test("htmlToVanCode: Hello", t => t.deepEqual(htmlToVanCode('<div><p>👋Hello</p><ul><li>🗺️World</li><li><a href="https://vanjs.org/">🍦VanJS</a></li></ul></div>'), {
    code: [
        'div(',
        '  p(',
        '    "👋Hello",',
...
test("htmlToVanCode: <input>", t => t.deepEqual(htmlToVanCode('<div><input type="text" name="name" value="value"></div>'), {
    code: [
        'div(',
...
test("htmlToVanCode: custom indent", t => t.deepEqual(htmlToVanCode('<div><p>👋Hello</p><ul><li>🗺️World</li><li><a href="https://vanjs.org/">🍦VanJS</a></li></ul></div>', { indent: 4 }), {
    code: [
        'div(',
        '    p(',
        '        "👋Hello",',
...
test("htmlToVanCode: skip empty text", t => t.deepEqual(htmlToVanCode(`<div>
  <p>👋Hello</p>
  <ul>
    <li>🗺️World</li>
...
test("htmlToVanCode: skip empty text - keep <pre>", t => t.deepEqual(htmlToVanCode(`<div>
  <h1>👋Hello</h1>
  <div>
...
test("htmlToVanCode: not skip empty text", t => t.deepEqual(htmlToVanCode(`<div>
  <p>👋Hello</p>
  <ul>
    <li>🗺️World</li>
    <li><a href="https://vanjs.org/">🍦VanJS</a></li>
...
test("htmlToVanCode: tags with lower camel case", t => t.deepEqual(htmlToVanCode('<clipPath id="circleClip"><circle cx="150" cy="150" r="100" /></clipPath>'), {
    code: [
...
test("htmlToVanCode: multiple elements", t => t.deepEqual(htmlToVanCode('<div><p>👋Hello</p><ul><li>🗺️World</li><li><a href="https://vanjs.org/">🍦VanJS</a></li></ul></div><p>Second Paragraph</p>'), {
    code: [
        'div(',
        '  p(',
        '    "👋Hello",',
...
test("htmlToVanCode: nested divs", t => t.deepEqual(htmlToVanCode('<div><div>1</div><div>2</div></div><div><div>3</div><div>4</div></div>'), {
    code: [
        'div(',
        '  div(',
        '    "1",',
...
test("htmlToVanCode: nested spans", t => t.deepEqual(htmlToVanCode('<span><span>1</span><span>2</span></span><span><span>3</span><span>4</span></span>'), {
    code: [
        'span(',
        '  span(',
        '    "1",',
...
test("mdToVanCode: custom renderer", t => t.deepEqual(mdToVanCode(`# Heading 1
## Heading 2
